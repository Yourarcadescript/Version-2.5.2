...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (isset($_SESSION['userid'])) {
		yasDB_update("UPDATE `user` SET website = '$website', name = '$name', email = '$email', location='$location', job='$job', aboutme='$aboutme', hobbies='$hobbies', shhobs='$shhobs', cmtsdisabled='$cmtsdisabled', shloc='$shloc', sheml='$sheml', shname='$shname', shabout='$shabout', deact='$deact' WHERE id = '$userid'");
