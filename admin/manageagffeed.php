...
<div class="top-bar">
<h1><?php $translate->__('Install ArcadeGameFeed.com - Game Feed for Your Arcade!');?></h1>
...
if($numrows == 0){
  echo '<center><h3>';
  $translate->__('Feed is not installed.');
  echo '</h3></center></div>';
...
<form enctype="multipart/form-data" action="index.php" method="get">
  ...
  <label for="category_filter"><?php $translate->__('Category');?>:</label>
    ...
    <option value="12">Coloring</option>
      ...
      <label for="ads_filter"><?php $translate->__('Game Ads');?>:</label>
  ...
  <?php $translate->__('Title');?>:<input type="text" name="title"/>&nbsp;&nbsp;
