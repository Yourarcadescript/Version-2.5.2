...
<div class="top-bar">
				...
				<h1><?php $translate->__('Cpanel - Forum Posts');?></h1>
		  ...
		  <div class="select-bar">
		    <label>
		    <h3><?php $translate->__('Manage Forum Post');?></h3>
		    </label>
		  </div>
<?php
...
if(!empty($_GET['edit'])) {
	...
	if($query->num_rows == 0) {
		...
		<div class="table">
	        ...
	        <tr>
	        <th class="full" colspan="2"><?php $translate->__('Edit - ');?><?php echo $row['id'];?></th>
			</tr>
			<tr>
			<td class="first"><strong><?php $translate->__('ID');?></strong></td>
			<td class="last"><?php echo $row['id'];?></td>
			</tr>
			<tr class="bg">
			<td class="first"><strong><?php $translate->__('Message');?></strong></td>
			...
			<tr class="bg">
			<td class="first"><strong><?php $translate->__('Topic ID');?></strong></td>
			<td class="last"><input type="text" name="topic" value="<?php echo $row['topic'];?>"  /></td>
			</tr>
            <tr>
			<td class="first"><strong><?php $translate->__('User');?></strong></td>
	...
	?><div class="table">
		...
		<table class="listing" cellpadding="0" cellspacing="0">
					<tr>
						...
						<th width="204px"><?php $translate->__('Message');?></th>
						<th><?php $translate->__('Date');?></th>
						<th><?php $translate->__('Topic ID');?></th>
						<th><?php $translate->__('User');?></th>
...
<?php
	...
	if($query->num_rows==0) {
		...
		while($row = $query->fetch_array(MYSQLI_ASSOC)) {
			...
			<td ><a href="index.php?act=manageposts&edit=<?php echo $row['id'];?>&m=1"><font color="#cc0000"><?php $translate->__('Edit');?></font></a></td>
			<td class="last"><a href="index.php?act=manageposts&delete=<?php echo $row['id'];?>" onclick="return confirm(\'Are you sure you want to delete this game?\')"><font color="#cc0000"><?php $translate->__('Delete');?></font></a><br/><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id'];?>"></td>
			</tr>
<?php
		}
	}
