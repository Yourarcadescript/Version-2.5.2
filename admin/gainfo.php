...
<div class="top-bar">
<h1><?php $translate->__('Cpanel - Social');?></h1>
<div class="breadcrumbs"><a href="index.php?act=manage_ga" title="<?php $translate->__('Google Analytics');?>"><?php $translate->__('Google Analytics Data');?></a></div>
</div><br />
<div class="select-bar">
<label>
<h3><?php $translate->__('Google Analytics Login Info');?></h3>
</label>
</div>
<?php
...
if(isset($_POST['edit_ga'])) {
	...
	<tr>
		<th class="full" colspan="2"><?php $translate->__('Google Analytics Login Info');?></th>
	</tr>
	<tr>
		<td class="first" style="width:100px;"><strong><?php $translate->__('Login (email)');?></strong></td>
		<td class="last"><input type="text" name="gaLogin" value="<?php echo $social['galogin'];?>" size="35"></td>
	</tr>
	<tr class="bg">
		<td class="first" style="width:100px;"><strong><?php $translate->__('New Password');?></strong></td>
		<td class="last"><input type="text" name="gaPassword" value="" size="35"></td>
	</tr>
	<tr>
		<td class="first" style="width:100px;"><strong><?php $translate->__('Profile Name');?></strong></td>
