...
<div class="top-bar">
				...
				<h1><?php $translate->__('Cpanel - Forum Categories');?></h1>
				<div class="breadcrumbs"><a href="index.php?act=general" title="<?php $translate->__('Settings');?>"><?php $translate->__('Settings');?></a> / <a href="index.php?act=links"><?php $translate->__('Links');?></a></div>
			</div><br />
		  <div class="select-bar">
		    <label>
		    <h3><?php $translate->__('Manage Forum Categories');?></h3>
		    </label>
		  </div>
<?php
if(!empty($_GET['edit'])) {
...
if (isset($_GET['page'])) {
	...
	<div class="table">
			...
			<tr>
						...
						<th width="200px"><?php $translate->__('Meta description');?></th>
	...
	while($row = $query->fetch_array(MYSQLI_ASSOC)) {
		...
		<td style="height:45px;"><a href="index.php?act=manageforumcats&edit=<?php echo $row['id'];?>"><font color="#cc0000"><?php $translate->__('Edit');?></font></a></td>
		<td class="last" style="height:45px;">
		<?php
		if ($row['id']) { ?>
		<a href="index.php?act=manageforumcats&delete=<?php echo $row['id'];?>" onclick="return confirm(\'Are you sure you want to delete this category?\')"><font color="#cc0000"><?php $translate->__('Delete');?></font></a><br/><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id'];?>">
		<?php } ?>
		</td>
		</tr>
