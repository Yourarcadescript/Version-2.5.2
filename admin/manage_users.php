...
<h1><?php $translate->__('Cpanel - Users');?></h1>
<div class="breadcrumbs"><a href="index.php?act=general" title="<?php $translate->__('Settings');?>"><?php $translate->__('Settings');?></a> / <a href="index.php?act=categories"><?php $translate->__('Categories');?></a> / <a href="index.php?act=links"><?php $translate->__('Links');?></a> / <a href="index.php?act=memberscomment" title="<?php $translate->__('Members Comments');?>"><?php $translate->__('Members Comments');?></a></div>
</div><br />
<div class="select-bar">
<label>
<h3><?php $translate->__('Manage Users');?></h3>
</label>
</div>
<?php
...
if(!empty($_GET['edit'])) {
   ...
   if($query->num_rows == 0) {
      ...
      $date = date("M/d/Y", $row['date']);?>
	        ...
	        <tr>
	        <th class="full" colspan="2"><?php $translate->__('Edit Member');?> - <?php echo $row['username'];?></th>
			</tr>
			<tr>
			<td class="first" width="172"><strong><?php $translate->__('Date joined');?></strong></td>
			<td class="last"><?php echo $date;?></td>
			</tr>
			<tr class="bg">
			<td class="first"><strong><?php $translate->__('Username');?></strong></td>
			...
			<tr class="bg">
			<td class="first"><strong><?php $translate->__('Website');?></strong></td>
			<td class="last"><input type="text" name="website" value="<?php echo $row['website'];?>" /></td>
			</tr>
            <tr>
			<td class="first"><strong><?php $translate->__('Ban for x days');?></strong></td>
...
elseif(!empty($_GET['delete'])) {
   ...
   if($query->num_rows == 0) {
		...
		<tr>
			<th class="first" style="width:35px;"><?php $translate->__('ID');?></th>
			<th style="width:100px;"><?php $translate->__('Username');?></th>
			<th style="width:100px;"><?php $translate->__('Date Joined');?></th>
			<th><?php $translate->__('Email');?></th>
			<th style="width:45px;"><?php $translate->__('Banned');?></th>
			<th style="width:35px;"><?php $translate->__('Edit');?></th>
			<th class="last" style="width:50px;"><?php $translate->__('Delete');?></th>
		</tr>
     ...
     while($row = $query->fetch_array(MYSQLI_ASSOC)) {
       ...
       <tr>
		...
		<td><a href="index.php?act=manage_users&edit=<?php echo $row['id'];?>"><font color="#cc0000"><?php $translate->__('Edit');?></font></a></td>
		<td class="last"><a href="index.php?act=manage_users&delete=<?php echo $row['id'];?>" onclick="return confirm(\'Are you sure you want to delete this user?\')"><font color="#cc0000"><?php $translate->__('Delete');?></font></a><br/><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id'];?>"></td>
	   </tr>
		<?php
	 } 
		$query->close();?>
