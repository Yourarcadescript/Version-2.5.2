...
<div class="top-bar">
		  ...
		  <div class="select-bar">
		    <label>
		    <h3><?php $translate->__('Manage GameQueue');?></h3>
		    </label>
		  </div>
	...
	if($query->num_rows==0) {
		echo '<div style="text-align:center;font-size:12px;"><br/><h1>';
    $translate->__('Your GameQueue is empty');
    echo '</h1><br/>';
    $translate->__('Load your GameQueue with games from the feed management pages.');
    echo '</div>';
	} else { 
		?>
    ...
    <div class="table">
		...
		<table class="listing" cellpadding="0" cellspacing="0">
			...
			<th><?php $translate->__('Title');?></th>
			<th width="125px"><?php $translate->__('Source Feed');?></th>
			<th class="last"></th>
			</tr>
		<?php
