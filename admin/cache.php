...
<div class="table">
	...
	<table class="listing form" cellpadding="0" cellspacing="0">
		<tr>
			<th class="full" colspan="2"><?php $translate->__('Clear Cache');?></th>
		</tr>
		<tr>
			<td class="first"><strong><?php $translate->__('Clear Page Cache');?></strong></td>
			<td class="last"><input type="checkbox" name="pagecache" value="pagecache" /></td>
		</tr>
		<tr>
			<td class="first"><strong><?php $translate->__('Clear Image Cache');?></strong></td>
