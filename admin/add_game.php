...
<div class="top-bar">
<h1><?php $translate->__('Cpanel - Upload Games');?></h1>
<div class="breadcrumbs"><a href="index.php?act=addmedia" title="<?php $translate->__('Add Media');?>"><?php $translate->__('Add Media');?></a> / <a href="index.php?act=addcode" title="<?php $translate->__('Add Code');?>"><?php $translate->__('Add Code');?></a> / <a href="index.php?act=managegames" title="<?php $translate->__('Manage Games');?>"><?php $translate->__('Manage Games');?></a> / <a href="index.php?act=brokenfiles" title="<?php $translate->__('Broken Files');?>"><?php $translate->__('Broken Files');?></a></div>
</div><br />
<div class="select-bar">
<label>
<h3><?php $translate->__('Add Game');?></h3>
</label>
</div>
<?php
...
if (isset($_POST['add'])) {
 ...
 <div class="table">
		...
		<tr>
	    <th class="full" colspan="2"><?php $translate->__('Upload A Game');?></th>
	    </tr>
		<tr>
		...
		<tr class="bg">
		<td class="first"><strong><?php $translate->__('Game File Type');?></strong></td>
		...
		<tr>
		<td class="first" width="172"><strong><?php $translate->__('Game File');?></strong></td>
