...
<div class="top-bar">
				...
				<h1><?php $translate->__('Cpanel - Forum Topics');?></h1>
		  ...
		  <div class="select-bar">
		    <label>
		    <h3><?php $translate->__('Manage Forum Topics');?></h3>
		    </label>
		  </div>
<?php
...
if(!empty($_GET['edit'])) {
	...
	if($query->num_rows == 0) {
		...
		<div class="table">
	        ...
	        <tr>
	        <th class="full" colspan="2"><?php $translate->__('Edit - ');?><?php echo $row['subject'];?></th>
			</tr>
			<tr>
			<td class="first" width="172"><strong><?php $translate->__('ID');?></strong></td>
			...
			<tr class="bg">
			<td class="first"><strong><?php $translate->__('Description');?></strong></td>
		...
		<?php } ?></select></td>
			...
			<tr class="bg">
			<td class="first"><strong><?php $translate->__('Author');?></strong></td>
			<td class="last"><input type="text" name="name" value="<?php echo $row['name'];?>"  /></td>
			</tr>
			<tr>
			<td class="first"><strong><?php $translate->__('Date');?></strong></td>
			<td class="last"><input type="text" name="date" value="<?php echo $row['date'];?>"  /></td>
			</tr>
			<tr>
			<td class="first"><strong><?php $translate->__('Views');?></strong></td>
	...
	?><div class="table">
		...
		<table class="listing" cellpadding="0" cellspacing="0">
					<tr>
						<th class="first"><?php $translate->__('Id');?></th>
						<th width="102px"><?php $translate->__('Topic');?></th>
						<th width="102px"><?php $translate->__('Category');?></th>
						<th><?php $translate->__('Author');?></th>
						<th><?php $translate->__('Views');?></th>
						<th><?php $translate->__('Edit');?></th>
...
<?php
	...
	if($query->num_rows==0) {
		...
		while($row = $query->fetch_array(MYSQLI_ASSOC)) {
			...
			<td ><a href="index.php?act=managetopics&edit=<?php echo $row['id'];?>&m=1"><font color="#cc0000"><?php $translate->__('Edit');?></font></a></td>
			<td class="last"><a href="index.php?act=managetopics&delete=<?php echo $row['id'];?>" onclick="return confirm(\'Are you sure you want to delete this topic?\')"><font color="#cc0000"><?php $translate->__('Delete');?></font></a><br/><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id'];?>"></td>
			</tr>
<?php
		}
	}
