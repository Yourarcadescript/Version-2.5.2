...
<div class="top-bar">
<a href="index.php?act=addlink" title="Add Link" class="button"><?php $translate->__('ADD LINK');?></a>
<h1><?php $translate->__('Cpanel - links');?></h1>
<div class="breadcrumbs"><a href="index.php?act=general" title="<?php $translate->__('Settings');?>"><?php $translate->__('Settings');?></a> / <a href="index.php?act=categories" title="<?php $translate->__('Categories');?>"><?php $translate->__('Categories');?></a></div>
</div><br />
<div class="select-bar">
<label>
<h3><?php $translate->__('Manage links');?></h3>
</label>
</div>
<?php
...
<form name="reset" method="post" action="">
			...
			<div class="table">
				...
				<tr>
						...
						<th style="width:75px;"><?php $translate->__('Site Title');?></th>
						<th style="width:175px;"><?php $translate->__('Site URL');?></th>
						<th><?php $translate->__('In');?></th>
						<th><?php $translate->__('Out');?></th>
						<th style="width:60px;"><?php $translate->__('Approved');?></th>
			...
			<td><a href="index.php?act=links&edit=<?php echo $row['id'];?>"><font color="#cc0000"><?php $translate->__('Edit');?></font></a></td>
		    <td class="last"><a href="index.php?act=links&delete=<?php echo $row['id'];?>" onclick="return confirm(\'Are you sure you want to delete this link?\')"><font color="#cc0000"><?php $translate->__('Delete');?></font></a><br/><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id'];?>"></td>
			</tr>
			<?php
		}
		$query->close();
