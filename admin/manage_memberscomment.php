...
<div class="top-bar">
<h1><?php $translate->__('Cpanel - Members Comments');?></h1>
<div class="breadcrumbs"><a href="index.php?act=comments" title="<?php $translate->__('Comments');?>"><?php $translate->__('Comments');?></a> / <a href="index.php?act=newsblogcomments" title="<?php $translate->__('News Blog Comments');?>"><?php $translate->__('News Blog Comments');?></a></div>
</div><br />
<div class="select-bar">
<label>
<h3><?php $translate->__('Manage Members Comments');?></h3>
</label>
</div>
<?php
if(!empty($_GET['edit'])) {
	...
	if($query->num_rows == 0) {
		...
		<tr>
						...
						<th style="width:42px;"><?php $translate->__('User ID');?></th>
						<th style="width:80px;"><?php $translate->__('Name');?></th>
						<th><?php $translate->__('Comment');?></th>
						<th style="width:100px;"><?php $translate->__('Ip Address');?></th>						
						<th width="40px"><?php $translate->__('Edit');?></th>
						<th class="last" style="width:42px;"><?php $translate->__('Delete');?></th>
					</tr>
		<?php
		while($row = $query->fetch_array(MYSQLI_ASSOC)) {
			...
			<td><a href="index.php?act=memberscomment&edit=<?php echo $row['id'];?>"><font color="#cc0000"><?php $translate->__('Edit');?></font></a></td>
			<td class="last"><a href="index.php?act=memberscomment&delete=<?php echo $row['id'];?>" onclick="return confirm(\'Are you sure you want to delete this members comment?\')"><font color="#cc0000"><?php $translate->__('Delete');?></font></a><br/><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id'];?>"></td>
			</tr>
			<?php
		}
		$query->close();
