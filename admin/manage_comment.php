...
<div class="top-bar">
<h1><?php $translate->__('Cpanel - Game Comments');?></h1>
<div class="breadcrumbs"><a href="index.php?act=memberscomment" title="<?php $translate->__('Members Comments');?>"><?php $translate->__('Members Comments');?></a> / <a href="index.php?act=newsblogcomments" title="<?php $translate->__('News Blog Comments');?>"><?php $translate->__('News Blog Comments');?></a></div>
</div><br />
<div class="select-bar">
<label>
<h3><?php $translate->__('Manage Comments');?></h3>
</label>
</div>
<?php
if(!empty($_GET['edit'])) {
	...
	if($query->num_rows == 0) {
		...
		<tr>
			...
			<th style="width:50px" ><?php $translate->__('Game ID');?></th>
			...
			<th width="30px"><?php $translate->__('Edit');?></th>
		...
		while($row = $query->fetch_array(MYSQLI_ASSOC)) {
			...
			<td><a href="index.php?act=comments&edit=<?php echo $row['id'];?>"><font color="#cc0000"><?php $translate->__('Edit');?></font></a></td>
			<td class="last"><a href="index.php?act=comments&delete=<?php echo $row['id'];?>" onclick="return confirm(\'Are you sure you want to delete this comment?\')"><font color="#cc0000"><?php $translate->__('Delete');?></font></a><br/><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id'];?>"></td>
			</tr>
			<?php
		}
		$query->close();		
