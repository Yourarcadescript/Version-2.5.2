...
<div class="breadcrumbs"><a href="index.php?act=addads" title="<?php $translate->__('Add ads');?>"><?php $translate->__('Add Ads');?></a></div>
</div><br />
<div class="select-bar">
<label>
<h3><?php $translate->__('Manage Ads');?></h3>
</label>
</div>
<?php
...
elseif(isset($_POST['delete_ad'])) {
	...
	while($row = $ads->fetch_array(MYSQLI_ASSOC)) {
		...
		<tr>
		<td class="first" width="172"><strong><?php $translate->__('Code for placement');?></strong></td>
		<td class="last"><label><?php echo highlight_string($ad,1); ?></label></td>
		</tr>
		<tr class="bg">
		<td class="first"><strong><?php $translate->__('Name');?></strong></td>
		<td class="last">
		<?php
		...
		<tr>
		<td class="first" width="172"><strong><?php $translate->__('Code');?></strong></td>
