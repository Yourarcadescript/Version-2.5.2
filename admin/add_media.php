...
<div class="top-bar">
<h1><?php $translate->__('Cpanel - Media');?></h1>
<div class="breadcrumbs"><a href="index.php?act=addcode" title="<?php $translate->__('Add Code');?>"><?php $translate->__('Add Code');?></a> / <a href="index.php?act=managegames" title="<?php $translate->__('Manage Games');?>"><?php $translate->__('Manage Games');?></a> / <a href="index.php?act=uploadgames" title="<?php $translate->__('Upload Games');?>"><?php $translate->__('Upload Games');?></a> / <a href="index.php?act=brokenfiles" title="<?php $translate->__('Broken Files');?>"><?php $translate->__('Broken Files');?></a></div>
</div><br />
<div class="select-bar">
<label>
<h3><?php $translate->__('Add Media');?></h3>
</label>
</div>
<?php
if(isset($_POST['add'])) {
...
?><div class="table">
		...
		<tr>
	    <th class="full" colspan="2"><?php $translate->__('ADD MEDIA TO YOUR SITE');?></th>
	    </tr>
		<tr>
		...
		<tr>
		<td class="first" width="172"><strong><?php $translate->__('File path');?></strong></td>
		<td class="last"><input type="text" name="file" value="media/files/" /></td>
		<tr class="bg">
		<td class="first" width="172"><strong><?php $translate->__('Height:*');?></strong></td>
		<td class="last"><input type="text" name="height" /></td>
		</tr>
		<tr>
		<td class="first" width="172"><strong><?php $translate->__('Thumbnail path');?></strong></td>
		...
		<tr>
		<td class="first" width="172"><strong><?php $translate->__('Keywords');?></strong></td>
		...
		<tr>
		<td class="first"><strong><?php $translate->__('Width:*');?></strong></td>
		...
		<br/><br/>
		<?php $translate->__('*Youtube videos automatically get title description keywords and thumbnail from Youtube API. Just put the video url in the File path box choose category and File drop menu youtube and click Add Media.');?>
<?php
}
?>
</div>