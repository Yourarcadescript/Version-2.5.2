...
<div class="top-bar">
				<a href="index.php?act=links" title="Link" class="button"><?php $translate->__('Links');?></a>
				<h1><?php $translate->__('Cpanel - Links Exchange');?></h1>
				<div class="breadcrumbs"><a href="index.php?act=links"><?php $translate->__('Links');?></a></div>
			</div><br />
		  <div class="select-bar">
		    <label>
		    <h3><?php $translate->__('Add Link');?></h3>
		    </label>
		  </div>
<?php
...
<?php } else { ?>
			...
			<tr>
	        <th class="full" colspan="2"><?php $translate->__('Add A Link');?></th>
			</tr>
			<tr>
			...
			<tr class="bg">
			<td class="first" width="172"><strong><?php $translate->__('Description');?></strong></td>
