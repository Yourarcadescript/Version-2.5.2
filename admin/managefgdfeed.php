...
<div class="top-bar">
<h1><?php $translate->__('Install FlashGameDistribution.com Games');?></h1></div>
<br/>
...
<h4><?php $translate->__('Note: Installing many games at once is resource intensive.');?></h4></center>
...
<form enctype="multipart/form-data" action="index.php" method="get">
	...
	<label>&nbsp;&nbsp;<?php $translate->__('Rating');?></label>
	...
	<div style="position:relative;float:left;margin-left:30px;">
		<input type="checkbox" name="featured" value="featured" /> <?php $translate->__('Featured Games');?><br>
		<input type="checkbox" name="multiplayer" value="multiplayer" /> <?php $translate->__('Multiplayer');?><br>
		<input type="checkbox" name="highscores" value="highscores" /> <?php $translate->__('Highscores');?><br>
		<input type="checkbox" name="mobileready" value="mobileready" /> <?php $translate->__('Mobile Ready');?><br>
		<input type="checkbox" name="hasads" value="hasads" /> <?php $translate->__('No Pregame Ads');?>
	</div>
</form>
