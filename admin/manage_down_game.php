...
<div class="top-bar">
				...
				<h1><?php $translate->__('Cpanel - Downloadable Games');?></h1>
				<div class="breadcrumbs"><a href="index.php?act=addmedia" title="<?php $translate->__('Add Media');?>"><?php $translate->__('Add Media');?></a> / <a href="index.php?act=addcode" title="<?php $translate->__('Add Code');?>"><?php $translate->__('Add Cod');?>e</a> / <a href="index.php?act=uploadgames" title="<?php $translate->__('Upload Games');?>"><?php $translate->__('Upload Games');?></a> / <a href="index.php?act=brokenfiles" title="<?php $translate->__('Broken Files');?>"><?php $translate->__('Broken Files');?></a></div>
			</div><br />
		  <div class="select-bar">
		    <label>
		    <h3><?php $translate->__('Manage Downloadable Games');?></h3>
		    </label>
		  </div>
<?php
if(!empty($_GET['edit'])) {
...
<div class="table">
		...
		<table class="listing" cellpadding="0" cellspacing="0">
					<tr>
						...
						<th><?php $translate->__('Thumb');?></th>
						<th><?php $translate->__('Game Title');?></th>
						<th><?php $translate->__('Description');?></th>
						<th><?php $translate->__('Down');?></th>
						<th><?php $translate->__('D.Mochi');?></th>
...
<?php
	...
	if($query->num_rows==0) {
		...
		<form name="deleteform" method="post" action="">
				...
				<td ><a href="index.php?act=managedowngame&edit=<?php echo $row['id'];?>&m=1"><font color="#cc0000"><?php $translate->__('Edit');?></font></a></td>
				<td class="last"><font color=red><a href="index.php?act=managedowngame&delete=<?php echo $row['id'];?>" onclick="return confirm(\'Are you sure you want to delete this game?\')"><font color="#cc0000"><?php $translate->__('Delete');?></font></a><br/><input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $row['id'];?>"></td>
				</tr>
		<?php
		}
		$query->close();
