...
<?php } ?>
  <?php if (!isset($_SESSION['user'])) { ?>
			  ...
			  <a href="<?php echo $setting['siteurl'];?>login.php?site=facebook" title="Login With Facebook">Facebook</a>&nbsp;/&nbsp;<a href="<?php echo $setting['siteurl'];?>login.php?site=twitter" title="Login With Twitter">Twitter</a>
			  </div>
  <?php } ?> 
</div>
<div id="top"><div id="nametext"><?php echo $setting['sitename']; ?></div></div>    
  <div id="bar">
	<?php			
	$query = yasDB_select("SELECT * FROM categories WHERE active='yes' AND parent='yes' ORDER BY `name` ASC");						
