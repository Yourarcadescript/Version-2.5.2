...
<div id="headergames2">Edit Profile</div>
<?php
if(isset($_SESSION["user"])) {
	$user=$_SESSION["user"];
} else {
	echo '<div class="containbox2">';
	echo '<enter>Not logged in!</center>';
...
if(isset($_GET['delete'])) {
  ...
  echo '<a href="'.$setting['siteurl'].'index.php">C;ick here to proceed</a></center>';
  echo '</div><div class="clear"></div></div>';
  include ("footer.php");
  exit;
  }
...
if(isset($_POST['settings'])) {
	...
	echo ' <div class="containbox2"><div id="preview"></div><div id="profileBox">'.$user.'s Profile:
