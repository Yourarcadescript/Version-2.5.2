...
?>
<div class="container_box1"><div class="forumheader"><?php if ($setting['seo'] == 'yes') {?><a href="<?php echo $setting['siteurl'].'forum.html';?>">Forum</a>&nbsp;&nbsp;>&nbsp;&nbsp;<span><?php echo $cat_data ['name'];?></span><?php } else { ?><a href="<?php echo $setting['siteurl'].'index.php?act=forum';?>">Forum</a>&nbsp;&nbsp;>&nbsp;&nbsp;<span><?php echo $cat_data ['name'];?></span><?php } ?></div>
