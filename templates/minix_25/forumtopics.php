...
$id = $row['id'];
?>
<div class="container_box1"><div class="forumheader"><?php if ($setting['seo'] == 'yes') { ?>
<a href="<?php echo $setting['siteurl'].'forum.html';?>">Forum</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="<?php echo $setting['siteurl'].'forumcats/'.$row['cat'].'/1.html';?>"><?php echo $cat['name'];?></a>&nbsp;&nbsp;>&nbsp;&nbsp;<span><?php echo $row ['subject'];?>
</span>
<?php } else { ?>
...
<a href="<?php echo $memberlink;?>"><img src="<?php echo $avatarimage;?>" width="60" height="60" align="center" title="<?php echo $username;?>"></a><br/><a href="<?php echo $memberlink;?>"><?php echo $username;?></a><br/>
...
<?php
    ...
    while($row = $query->fetch_array(MYSQLI_ASSOC)) {
		...
		<tr>
		<td class="first style4"><a href="<?php echo $memberlink;?>"><?php echo $username;?></a><br/><a href="<?php echo $memberlink;?>"><img src="<?php echo $avatarimage;?>" width="60" height="60" align="center" title="<?php echo $username;?>"></a>
		<br/>
	...
	if (isset($_POST['Submit'])) {
		...
		if($result){
			...
			if ($setting['seo']=='yes') {
				...
				$answerlink = $setting['siteurl'].'index.php?act=forumtopics&id='.$topic;
			}
			?>
		...
		<textarea rows="6" cols="84" id="text" name="text"></textarea></div><div class="clear"></div>
		<div style="float:left; width:740px;">
