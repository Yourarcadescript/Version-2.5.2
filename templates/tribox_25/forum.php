...
Chat:<input type="text" name="text" style="width:200px; color:#999" onkeyup="noBad(this);" onblur="this.value = this.value || this.defaultValue; this.style.color = '#999';" onfocus="this.value=''; this.style.color = '#000';" value="Chat here!"/>
<input type="submit" class="shoutbutton" name="Submit" value="Shout"/>&nbsp;<a href="<?php echo $forumurl;?>" onlick="location.reload();"><img src="<?php echo $setting['siteurl'].'templates/'.$setting['theme'].'/skins/'.$setting['skin'].'/images/refresh.png';?>" style="width:24px;height:24px;position:absolute;" align="center" title="Refresh"></a>
