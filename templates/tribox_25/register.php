<div id="center">
    <div id="register_main_header">Register:</div>   
    <div id="register_main_box">
        <div id="register">
            <?php
           ...
           <div id="preview" style="text-align:center;color:#990000;"></div><div id="contactBox" style="text-align:center;">
