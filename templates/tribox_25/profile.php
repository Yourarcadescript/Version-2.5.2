<div id="center">
<div id="edit_profile_header">Edit Profile</div>
<div id="edit_profile_box">
<?php
...
if(isset($_POST['settings'])) {
	...
	echo ' <div id="edit_profile"><div id="preview"></div><div id="profileBox">
...
<table class="tg">
  ...
  <tr>
    ...
    <td class="tg-vn4c"><input type="text" name="name" value="' . $row['name'] . '" size="24" /></td>
    <td class="tg-vn4c">Email:</td>
    <td class="tg-vn4c"><input type="text" name="email" value="' . $row['email'] . '" size="24" /></td>
  </tr>
  <tr>
    <td class="tg-0ord">Website:(Remember the http://)</td>
    <td class="tg-0ord"><input type="text" name="website" value="' . $row['website'] . '" size="24" /></td>
    <td class="tg-Oord">Location:</td>
    <td class="td-Oord"><input type="text" name="location" value="' . $row['location'] . '" size="24" /></td>
  </tr>
  <tr>
