...
<title>Install YourArcadeScript Version 2.5</title>
...
function PageURL() {
	...
	if(isset($_POST['dbcheck'])){
		...
		if (!$mysqli->real_connect($_POST['host'], $_POST['username'], $_POST['password'], $_POST['database'])) {
			...
			$_POST['form'] = 'set';
			?>			
			<form action="YAS251install.php" method="post">
		...
		?><option value="minix_25" selected="yes">minix_25</option><?php
		...
		<?php
		$skins = scandir(str_replace('\\', '/', realpath(dirname(__FILE__))).'/templates/minix_25/skins/');
		$n = 0;
...
?>';
	   ...
	   /*  Create the database tables and insert default and user data */    		
		...
		$mysqli->query("CREATE TABLE IF NOT EXISTS `games` (
		  ...
		  `type` enum('IMAGE','MOV','MPG','AVI','FLV','WMV','SWF','DCR','YOUTUBE','CustomCode') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'SWF',
		  `source` enum('OTHER','MOCHI','FGD','PLAYTOMIC','FOG','KONGREGATE','VASCOGAMES') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'OTHER',
		...
		$mysqli->query("CREATE TABLE IF NOT EXISTS `mochicatlookup` (
		  `id` int(10) unsigned NOT NULL,
		  `action` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Action',
		  `adventure` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Adventure',
		  `board game` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Other',
		  `casino` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Casino',
		  `dress-up` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Dressup',
		  `driving` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Adventure',
		  `fighting` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Action',
		  `other` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Other',
		  `customize` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Dressup',
		  `puzzles` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Puzzle',
		  `shooting` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Shooter',
		  `sports` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Sports',
		  `Education` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Other',
		  `Rhythm` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Action',
		  `Jigsaw` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Puzzle',
		  `Strategy` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Strategy',
		  PRIMARY KEY (`id`)
		) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;");

		$mysqli->query("INSERT INTO `mochicatlookup` (`id`, `action`, `adventure`, `board game`, `casino`, `dress-up`, `driving`, `fighting`, `other`, `customize`, `puzzles`, `shooting`, `sports`, `Education`, `Rhythm`, `Jigsaw`, `Strategy`) VALUES
		(1, 'Action', 'Adventure', 'Other', 'Casino', 'Dressup', 'Adventure', 'Action', 'Other', 'Dressup', 'Puzzle', 'Shooter', 'Sports', 'Other', 'Action', 'Puzzle', 'Strategy');");

		$mysqli->query("CREATE TABLE IF NOT EXISTS `mochigames` (
		  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
		  `gameurl` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `width` int(11) NOT NULL,
		  `height` int(11) NOT NULL,
		  `description` text COLLATE utf8_unicode_ci NOT NULL,
		  `keywords` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
		  `thumburl` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `categories` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
		  `gametagid` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
		  `screenthumburl1` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `instructions` text COLLATE utf8_unicode_ci NOT NULL,
		  `rating` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
		  `leaderboard` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
		  `coinsenabled` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
		  `revshareenabled` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
		  `recommended` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
		  `isinstalled` int(10) NOT NULL DEFAULT '0',
		  `slug` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
		  `thumbnail_200x200` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `screenthumburl2` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `screenthumburl3` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `screenthumburl4` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `uuid` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
		  `author` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
		  `hidden` tinyint(1) unsigned NOT NULL DEFAULT '0',
		  PRIMARY KEY (`id`),
		  UNIQUE KEY `gametagid` (`gametagid`)
		) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;");
		...
		$mysqli->query("CREATE TABLE IF NOT EXISTS `playtomicfeed` (
		  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
		  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
		  `gameurl` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `width` int(11) NOT NULL,
        ...
        $mysqli->query("CREATE TABLE IF NOT EXISTS `settings` (
		  ...
		  `version` varchar(12) COLLATE utf8_unicode_ci NOT NULL DEFAULT '2.5.1',
		  `theme` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT 'modbox_25',
		  `skin` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'twinspeaks',
		...
		$mysqli->query("INSERT INTO `settings` (`id`, `main`, `gperpage`, `numbgames`, `gamesort`, `seolink`, `seo`, `approvelinks`, `numblinks`, `version`, `theme`, `skin`, `password`, `mochi_pub_key`, `mochi_secret_key`, `userecaptcha`, `lightbox`, `email`, `disabled`, `fb_app_id`, `fb_app_secret`, `tw_app_id`, `tw_app_secret`, `cachelife`, `siteurl`, `sitepath`, `sitename`, `slogan`, `metades`, `metakeywords`, `jobs`, `galogin`, `gapassword`, `gaurl`) VALUES
        (1, 1, 15, 3, 'newest', 'yes', 'no', 'no', 10, '2.5.1', '".mysql_escape_string($_POST['theme'])."', '".mysql_escape_string($_POST['skin'])."', '".md5('admin')."', '', '', 'yes', 'no', '".mysql_escape_string($_POST['supportemail'])."', 'no', '".mysql_escape_string($_POST['fbAppId'])."', '".mysql_escape_string($_POST['fbAppSecret'])."', '".mysql_escape_string($_POST['twAppId'])."', '".mysql_escape_string($_POST['twAppSecret'])."', 60, '".mysql_escape_string($_POST['siteurl'])."', '".mysql_escape_string($_POST['sitepath'])."', '".mysql_escape_string($_POST['sitename'])."', '".mysql_escape_string($_POST['slogan'])."', '".mysql_escape_string($_POST['metades'])."', '".mysql_escape_string($_POST['keywords'])."', '$jobstring', '', '', '')");
		...
		$mysqli->query("CREATE TABLE IF NOT EXISTS `vascogames` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
		  `vasco_id` int(11) NOT NULL,
		  `title` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
		  `file` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `thumbnail` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
		  `width` int(11) NOT NULL,
...
$result = curl_exec($ch);
curl_close($ch);	   
echo "<br/>Site data set. YAS251install.php must be renamed or deleted before you can use your site.<br/><br/>";
echo '</div>
	</div>
	</body>
	</html>';
